...
conv_6=conv_layer(pool_1, shape=[3, embedding_size, 64, 128])
...
conv_10=conv_layer(pool_2, shape=[3, embedding_size, 128, 256])
...
conv_12=conv_layer(batch_norm_11, shape=[3, embedding_size, 256, 256])
batch_norm_12=tf.nn.relu(tf.contrib.layers.batch_norm(conv_12))   #Batch Normalization
conv_13=conv_layer(batch_norm_12, shape=[3, embedding_size, 256, 256])
...
conv_14=conv_layer(pool_2, shape=[3, embedding_size, 256, 512])
